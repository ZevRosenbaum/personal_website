...
const clientId = '427845ffbbbd4897ba198bdf3cc2c956';
const redirectUri = 'file:///Users/zevrosenbaum/Desktop/GuessThatSongGame/templates/index.html';
const scopes = [
  'streaming',
  'user-read-birthdate',
  'user-read-private',
...
function getRecommendations(seeds) {
  $.ajax({
    url: "https://api.spotify.com/v1/recommendations?seed_artists=" + seeds + '&limit=1',
    type: "GET",
    beforeSend: function(xhr){xhr.setRequestHeader('Authorization', 'Bearer ' + _token );},
    success: function(data) { 
      console.log(data)
